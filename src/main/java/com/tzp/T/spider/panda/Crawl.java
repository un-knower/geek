package com.tzp.T.spider.panda;
...
public class Crawl extends Thread {
     ...
     * @throws IOException
     */
    public boolean init() throws IOException, JSONException {
        ...
        if (errno != 0) {
            ...
            for(int i=0;i<chat_addr_list.length();i++){
                Object o = chat_addr_list.get(i);
