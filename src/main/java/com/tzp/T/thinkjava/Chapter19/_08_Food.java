...
import com.tzp.T.thinkjava.Chapter19.Recipe.American;
import com.tzp.T.thinkjava.Chapter19.Recipe.Chinese;
import com.tzp.T.thinkjava.Chapter19.Recipe.Japanese;
...
public class _08_Food {
    public static void main(String[] args) {
        ...
        System.out.println("服务员：" + Recipe.Chinese.宫保鸡丁.show());
        System.out.println("客人：好，来一个");
        recipe.add(Recipe.Chinese.宫保鸡丁);
        System.out.println("客人：这个咋样？");
        System.out.println("服务员：" + Recipe.Chinese.鱼香肉丝.show());
        System.out.println("客人：哦，我不喜欢甜的");
        recipe.add(Recipe.American.hotdog);
        recipe.add(Recipe.Japanese.寿司);
