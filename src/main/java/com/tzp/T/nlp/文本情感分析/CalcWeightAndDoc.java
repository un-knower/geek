...
public class CalcWeightAndDoc {
    ...
    //这两个是词典的位置
    private final String posiDictPath = "F:\\0\\0-Data\\台湾大学情感极性词典\\NTUSD_positive_simplified.txt";
    private final String negaDictPath = "F:\\0\\0-Data\\台湾大学情感极性词典\\NTUSD_negative_simplified.txt";
